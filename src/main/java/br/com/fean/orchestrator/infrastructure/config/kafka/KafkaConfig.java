package br.com.fean.orchestrator.infrastructure.config.kafka;
...
public class KafkaConfig {
    ...
    @Bean
    public NewTopic customerSuccessTopic() {
        return buildTopic(CUSTOMER_SUCCESS.getTopic());
    }

    @Bean
    public NewTopic customerFailTopic() {
        return buildTopic(CUSTOMER_FAIL.getTopic());
    }
